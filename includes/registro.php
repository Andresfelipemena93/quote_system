...
<div class="row" style="margin-top: 10%;">
    <div class="col-sm-12 col-lg-4 offset-lg-4">
        <h2 style="font-size:1rem;">Registro Nuevo Usuario</h2>
        <div class="alert alert-info" style="background-color: #008000;">
...
<div class="row" id="app">
    <div class="col-sm-12 col-lg-4 offset-lg-4">
        <form ref="form" method="post" action="<?php echo BASE_URL ?>/?p=guardar_usuario">
            ...
            <button type="button" @click="registrar" class="btn btn-primary" style="background-color:#1e3662; border-color:#fff;">Registrarme</button>
            <br>
            <a href="<?php echo BASE_URL ?>?p=login" style="color:#008000;">Ya tengo una cuenta</a>
        </form>
    </div>
