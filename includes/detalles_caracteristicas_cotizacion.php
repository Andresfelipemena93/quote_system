            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <form method="post" action="<?php echo BASE_URL ?>/?p=agregar_servicio_a_cotizacion">
                        ...
                        <div class="form-group">
                            <label for="tiempoEnMinutos">Tiempo Estimado de Entrega</label>
                        ...
                        <button type="submit" class="btn btn-primary" style="background-color: #1e3662; border-color:#fff;">Guardar</button>
                    </form>
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <form method="post" action="<?php echo BASE_URL ?>/?p=agregar_caracteristica_a_cotizacion">
                        ...
                        <input type="hidden" name="tokenCSRF" value="<?php echo $tokenCSRF ?>">
                        <div class="form-group">
                            <label for="caracteristica">Características de los productos</label>
