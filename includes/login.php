...
<div class="row" style="margin-top: 10%; color:#1e3662;">
    ...
    <div class="col-sm-12 col-lg-4 offset-lg-4">
        <form ref="form" method="post" action="<?php echo BASE_URL ?>/?p=iniciar_sesion">
            ...
            if (isset($_GET["mensaje"])) {
                ?>
                <br>
                <div class="alert" style="color: #fff; background-color: #c1121f;">
            ...
            <?php } ?>
            <div class="alert" style="color: #fff; background-color: #008000;">
                <strong>“El secreto del gran éxito radica en el trabajo de un gran equipo”</strong>
                 Murillo Cinta de Oliveira Margarida.
            </div>
            <button type="submit" class="btn btn-primary" style="background-color: #1e3662; border-color:#fff;">Entrar <i class="fa fa-arrow-right"></i></button>
            <br>
            <a  href="<?php echo BASE_URL ?>?p=registro" style="color: #1e3662;">Registrarme</a>
        </form>
    </div>
</div>
