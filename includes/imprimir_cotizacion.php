...
<div id="app">
    <div class="row">
        <div class="col-sm">
            ...
            <?php endif ?>
            <span class="badge badge-pill badge-success" style="border-color:#fff;"><?php echo htmlentities($cotizacion->fecha) ?></span>
        </div>
    </div>
    <div class="row">
        <div class="col-sm">
    ...
    <div class="row d-print-block d-sm-none">
        <hr>
        <div class="col-sm">
            Conoce los términos y condiciones de Garantías en:
            <strong>https://www.lirvan.com/garantias.html</strong>
        </div>
    </div>
    <div class="row">
        <div class="col-sm">
